...
c      	print*,'Test 6'
c    Intel fortran compiler doesn't like this return statement:
c    "Drivers/aq_driver_function.f(1237): error #6353: A RETURN
c    statement is invalid in the main program."
c	return
c
